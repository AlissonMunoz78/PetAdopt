      ...
      <View style={styles.container}>
        ...
        {error && (
          <View style={styles.errorBox}>
            <IconSymbol name="exclamationmark.triangle.fill" color={CORAL} size={16} />
...
const styles = StyleSheet.create({
  ...
  center: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#FCFAF8' },
  ...
  errorBox: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#FFF0F2', borderRadius: 8, padding: 12, marginBottom: 16 },
  errorText: { color: CORAL, fontSize: 13, flex: 1 },
  inputWrapper: { flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1.5, borderBottomColor: '#DDD', paddingVertical: 14, gap: 12, marginBottom: 8 },
  input: { flex: 1, fontSize: 16, color: '#222' },
  btn: { backgroundColor: CORAL, borderRadius: 100, height: 54, justifyContent: 'center', alignItems: 'center', marginTop: 24 },
